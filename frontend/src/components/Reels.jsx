...
const Reels = ({ post, refetch }) => {
  ...
  const handleFollow = async (userId) => {
    ...
    try {
      const res = await axios.post(
        `https://speedstergram.onrender.com/api/v1/user/follow/${userId}`,
        {},
      );
  ...
  const handleLike = async () => {
    try {
     const res = await axios.post(
        `https://speedstergram.onrender.com/api/v1/post/like/${post._id}`,
        {},
  ...
  const handleSave = async () => {
    try {
     const res =  await axios.post(
        `https://speedstergram.onrender.com/api/v1/post/bookmark/${post._id}`,
        {},
        { withCredentials: true }
      );
    console.log(res.data);
  ...
  const handleDelete = async () => {
    try {
      const res = await axios.delete(
        `https://speedstergram.onrender.com/api/v1/post/delete/${post._id}`,
        { withCredentials: true }
      );
    console.log(res.data);
