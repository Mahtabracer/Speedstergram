...
const Login = () => {
  ...
  const loginHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://speedstergram.onrender.com/api/v1/user/login", input, {
      ...
      <div className="flex w-full max-w-5xl justify-center items-center gap-12">
        ...
        <div className="w-full max-w-sm">
          <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 p-8 rounded-lg text-center shadow-sm">
            <h1 className="text-4xl satisfy-regular text-black dark:text-white mb-6">Speedstergram</h1>
